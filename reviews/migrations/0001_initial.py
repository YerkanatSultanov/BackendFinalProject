    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.CharField(help_text='The price of the book', max_length=50)),
                ('hasSale', models.BooleanField(help_text='Определяет есть ли скидка или нет')),
                ('saleFromPrice', models.CharField(help_text='Для определения новой ценны учитывая скидку', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(help_text='The category of the book', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Contributor',
